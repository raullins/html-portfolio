...
function jogarJokenpo(escolhaDoJogador){
  ...
  document.querySelector('.js-jogadas').innerHTML = `Você escolheu: <img src="../assets/images/${escolhaDoJogador}-emoji.png" class="iconeJogada"> e o computador escolheu <img src="../assets/images/${resultadoComp}-emoji.png" class="iconeJogada">.`;
